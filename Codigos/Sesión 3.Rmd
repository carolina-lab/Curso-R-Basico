...
Se utilizará la base de datos "BostonHousing" que contiene el paquete mlbench y usando la función **tapply** calcular, la media, la median, media recortada, los cuartiles, desviación estádar, de las concentraciones de óxidos de nitrógeno en los ríos 
